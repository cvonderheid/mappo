...
@Component
public class HttpGithubReleaseManifestSourceClient implements ReleaseManifestSourceClient {
    ...
    @Autowired
    public HttpGithubReleaseManifestSourceClient(MappoProperties properties) {
        this(
            properties,
    ...
    HttpGithubReleaseManifestSourceClient(MappoProperties properties, HttpClient httpClient) {
