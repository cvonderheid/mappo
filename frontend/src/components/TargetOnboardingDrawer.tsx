              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                    ...
                    <FieldHelpTooltip content="The project profile this target belongs to. Validation rules and deployment behavior come from this selection." />
                  </div>
                  <Select
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                    ...
                    <FieldHelpTooltip content="Unique onboarding event identifier for audit/history. Auto-generated by default." />
                  </div>
                  <Input
                    id="onboard-event-id"
                    value={draft.eventId}
                ...
                <div className="space-y-1 lg:col-span-3">
                  <div className="flex items-center gap-1">
                    ...
                    <FieldHelpTooltip content="Only needed if marketplace/onboarding ingest token validation is enabled. Leave blank otherwise." />
                  </div>
                  <Input
