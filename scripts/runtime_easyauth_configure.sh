...
Options:
  ...
  --output-env-file <path>         Output env file (default: .data/mappo.env)
...
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_ENABLED "true"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_SUBSCRIPTION_ID "${SUBSCRIPTION_ID}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_TENANT_ID "${TENANT_ID}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_APP_OBJECT_ID "${APP_OBJECT_ID}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_CLIENT_ID "${APP_CLIENT_ID}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_CLIENT_SECRET "${APP_CLIENT_SECRET}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_APP_DISPLAY_NAME "${APP_DISPLAY_NAME}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_FRONTEND_URL "${FRONTEND_URL}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_CALLBACK_URL "${callback_url}"
upsert_env_var "${OUTPUT_ENV_FILE}" MAPPO_EASYAUTH_LOGOUT_URL "${logout_url}"
