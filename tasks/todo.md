...
- 2026-03-06: Added internal execution context loading in `/Users/cvonderheid/workspace/mappo/backend-java/src/main/java/com/mappo/controlplane/repository/TargetRepository.java` so runs can resolve managed resource group and container app metadata without expanding the public `TargetRecord` API.
